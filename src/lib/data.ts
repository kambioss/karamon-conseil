...
export interface Project {
  ...
  endDate: string | null
  image: string | null
  /** Liste d'actions, stockée en JSON (string) pour rester compatible avec le code existant */
  actions: string | null
  /** Liste de résultats, stockée en JSON (string) pour rester compatible avec le code existant */
  results: string | null
  createdAt: string
  updatedAt: string
}
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    slug: "projet-2",
    description:
      "Réalisation de six Études d'Impact Environnemental et Social pour les réseaux de distribution de six systèmes autonomes d'adduction en eau potable (AEP), dans les localités de Sanguéra, Zanguéra, Klikamé, Apéssito-Togblékopé, Adétikopé-Est et Dévégo.",
    descriptionEn:
      "Six Environmental and Social Impact Assessments for the distribution networks of six standalone water supply systems, in the localities of Sanguéra, Zanguéra, Klikamé, Apéssito-Togblékopé, Adétikopé-Est and Dévégo.",
    fullDescription:
      "Dans le cadre du renforcement de l'accès à l'eau potable en milieu rural et périurbain au Togo, KARAMON CONSEIL a été chargé de la réalisation de six Études d'Impact Environnemental et Social (EIES) portant sur les réseaux de distribution de six systèmes autonomes d'Adduction en Eau Potable (AEP).\n\nLes six localités concernées sont Sanguéra, Zanguéra, Klikamé, Apéssito-Togblékopé, Adétikopé-Est et Dévégo. Le projet, financé par la Banque mondiale, vise à sécuriser l'approvisionnement en eau potable de ces communautés à travers la mise en place de systèmes autonomes de distribution.\n\nChaque EIES a permis d'identifier les impacts environnementaux et sociaux spécifiques à chaque site, et de proposer des mesures d'atténuation et un cadre de suivi conforme aux exigences de sauvegarde de la Banque mondiale.",
    fullDescriptionEn:
      "As part of efforts to strengthen access to drinking water in rural and peri-urban areas of Togo, KARAMON CONSEIL was tasked with carrying out six Environmental and Social Impact Assessments (ESIA) for the distribution networks of six standalone water supply systems.\n\nThe six localities concerned are Sanguéra, Zanguéra, Klikamé, Apéssito-Togblékopé, Adétikopé-Est and Dévégo. The project, financed by the World Bank, aims to secure drinking water supply for these communities through the establishment of standalone distribution systems.\n\nEach ESIA identified the environmental and social impacts specific to its site and proposed mitigation measures and a monitoring framework in line with World Bank safeguard requirements.",
  ...
  },
  {
    ...
    slug: "projet-3",
    description:
      "Élaboration de six Plans d'Action de Réinstallation pour les réseaux de distribution de six systèmes autonomes d'adduction en eau potable, dans les mêmes localités de Sanguéra, Zanguéra, Klikamé, Apéssito-Togblékopé, Adétikopé-Est et Dévégo.",
    descriptionEn:
      "Preparation of six Resettlement Action Plans for the distribution networks of six standalone water supply systems, in the same localities of Sanguéra, Zanguéra, Klikamé, Apéssito-Togblékopé, Adétikopé-Est and Dévégo.",
    fullDescription:
      "En complément des EIES réalisées pour les réseaux de distribution des six systèmes autonomes d'Adduction en Eau Potable (AEP), KARAMON CONSEIL a élaboré six Plans d'Action de Réinstallation (PAR) pour les localités de Sanguéra, Zanguéra, Klikamé, Apéssito-Togblékopé, Adétikopé-Est et Dévégo, au Togo.\n\nCette mission, financée par la Banque mondiale, a consisté à identifier les personnes et biens affectés par les emprises des réseaux de distribution, à évaluer les préjudices subis et à proposer des mesures de compensation et de restauration des moyens de subsistance conformes aux standards internationaux.\n\nLes PAR élaborés intègrent également des mécanismes de gestion des plaintes et un dispositif de consultation continue des populations riveraines tout au long de la mise en œuvre des travaux.",
    fullDescriptionEn:
      "In addition to the ESIAs carried out for the distribution networks of the six standalone water supply systems, KARAMON CONSEIL prepared six Resettlement Action Plans (RAP) for the localities of Sanguéra, Zanguéra, Klikamé, Apéssito-Togblékopé, Adétikopé-Est and Dévégo, in Togo.\n\nThis assignment, financed by the World Bank, involved identifying the people and assets affected by the distribution network rights-of-way, assessing the losses incurred, and proposing compensation and livelihood restoration measures in line with international standards.\n\nThe RAPs also include grievance management mechanisms and a framework for ongoing consultation with local communities throughout the works.",
    client: "Gouvernement du Togo / Banque mondiale",
    clientEn: "Government of Togo / World Bank",
    location: "Sanguéra, Zanguéra, Klikamé, Apéssito-Togblékopé, Adétikopé-Est et Dévégo, Togo",
    locationEn: "Sanguéra, Zanguéra, Klikamé, Apéssito-Togblékopé, Adétikopé-Est and Dévégo, Togo",
  ...
  },
  {
    ...
    slug: "projet-5",
    description:
      "Élaboration du Plan d'Action de Réinstallation pour le projet de construction de 20 000 logements à coût abordable à Kpomé, financé par la Banque Africaine de Développement.",
    descriptionEn:
      "Preparation of the Resettlement Action Plan for the construction of 20,000 affordable housing units in Kpomé, financed by the African Development Bank.",
    fullDescription:
  ...
  },
  {
    ...
    slug: "projet-7",
    description:
      "Études d'Impact Environnemental et Social et Plan d'Action de Réinstallation du projet d'autoroute Abidjan-Lagos, Lot 1 Abidjan-Takoradi, Tronçon 2 Elubo-Takoradi (80 km), au Ghana.",
    descriptionEn:
      "Environmental and Social Impact Assessment and Resettlement Action Plan for the Abidjan-Lagos highway project, Lot 1 Abidjan-Takoradi, Section 2 Elubo-Takoradi (80 km), in Ghana.",
    fullDescription:
      "En complément de l'intervention sur le tronçon ivoirien, KARAMON CONSEIL a réalisé les Études d'Impact Environnemental et Social (EIES) et le Plan d'Action de Réinstallation (PAR) du Tronçon 2 Elubo-Takoradi, long de 80 km, situé au Ghana, dans le cadre du même Projet Corridor Abidjan-Lagos.\n\nCe tronçon fait partie du Lot 1 Abidjan-Takoradi du corridor routier régional, financé par la Banque Africaine de Développement en partenariat avec l'UEMOA, visant à améliorer la connectivité et les échanges commerciaux entre les pays du golfe de Guinée.\n\nLa mission a couvert l'évaluation des impacts environnementaux et sociaux du tracé, ainsi que le recensement des personnes affectées et l'élaboration de mesures de compensation adaptées au contexte ghanéen.",
    fullDescriptionEn:
      "In addition to the work carried out on the Ivorian section, KARAMON CONSEIL carried out the Environmental and Social Impact Assessment (ESIA) and Resettlement Action Plan (RAP) for the 80 km Elubo-Takoradi Section 2, located in Ghana, under the same Abidjan-Lagos Corridor Project.\n\nThis section is part of Lot 1 Abidjan-Takoradi of the regional road corridor, financed by the African Development Bank in partnership with UEMOA, aiming to improve connectivity and trade between the Gulf of Guinea countries.\n\nThe assignment covered the assessment of the environmental and social impacts of the alignment, as well as the census of affected people and the design of compensation measures tailored to the Ghanaian context.",
    client: "Banque Africaine de Développement / UEMOA",
    clientEn: "African Development Bank / UEMOA",
  ...
  },
  {
    ...
    slug: "projet-10",
    description:
      "Réalisation de l'audit de la mise en œuvre du Plan d'Action de Réinstallation des travaux d'extension du réseau de distribution d'électricité dans la ville de Bissau et ses quartiers périphériques.",
    descriptionEn:
      "Audit of the implementation of the Resettlement Action Plan for the extension works of the electricity distribution network in the city of Bissau and its outlying districts.",
    fullDescription:
      "KARAMON CONSEIL a réalisé l'audit de la mise en œuvre du Plan d'Action de Réinstallation (PAR) relatif aux travaux d'extension du réseau de distribution d'électricité dans la ville de Bissau et ses quartiers périphériques, en Guinée-Bissau.\n\nCe projet, financé par la Banque Africaine de Développement, vise à améliorer l'accès à l'électricité pour les populations urbaines et périurbaines de la capitale bissau-guinéenne.\n\nL'audit a permis de vérifier l'effectivité des mesures de compensation et de restauration des moyens de subsistance prévues par le PAR, ainsi que la conformité de leur mise en œuvre aux exigences de sauvegarde de la BAD.",
    fullDescriptionEn:
      "KARAMON CONSEIL carried out the audit of the implementation of the Resettlement Action Plan (RAP) related to the extension works of the electricity distribution network in the city of Bissau and its outlying districts, in Guinea-Bissau.\n\nThis project, financed by the African Development Bank, aims to improve access to electricity for urban and peri-urban populations in the Bissau-Guinean capital.\n\nThe audit verified the effectiveness of the compensation and livelihood restoration measures set out in the RAP, as well as the compliance of their implementation with AfDB safeguard requirements.",
  ...
  },
  {
    ...
    slug: "projet-11",
    description:
      "Audit de la mise en œuvre du Plan d'Action de Réinstallation sur la section du lot 1 allant d'Aouda à Alhéridè, dans le cadre des travaux de réhabilitation routière au Togo.",
    descriptionEn:
      "Audit of the implementation of the Resettlement Action Plan on the Lot 1 section from Aouda to Alhéridè, as part of road rehabilitation works in Togo.",
    fullDescription:
      "KARAMON CONSEIL a réalisé l'audit de la mise en œuvre du Plan d'Action de Réinstallation (PAR) portant sur la section du lot 1 allant d'Aouda à Alhéridè, dans le cadre des travaux de réhabilitation de la Route Nationale 1 au Togo, financés par la Banque mondiale.\n\nL'audit a consisté à vérifier l'effectivité du versement des compensations aux personnes affectées par le projet, la mise en œuvre des mesures de restauration des moyens de subsistance et la conformité du processus aux standards de sauvegarde de la Banque mondiale.\n\nCette mission s'inscrit dans le cadre plus large des travaux de réhabilitation de la RN1, un axe routier stratégique pour la connectivité régionale du Togo.",
    fullDescriptionEn:
      "KARAMON CONSEIL carried out the audit of the implementation of the Resettlement Action Plan (RAP) covering the Lot 1 section from Aouda to Alhéridè, as part of the National Road 1 rehabilitation works in Togo, financed by the World Bank.\n\nThe audit verified the effective payment of compensation to people affected by the project, the implementation of livelihood restoration measures, and the compliance of the process with World Bank safeguard standards.\n\nThis assignment is part of the broader RN1 rehabilitation works, a strategic road axis for Togo's regional connectivity.",
    client: "Banque mondiale",
    clientEn: "World Bank",
  ...
  },
  {
    ...
    slug: "projet-12",
    description:
      "Audit de performance environnementale et sociale du Projet de Promotion de l'Assainissement Inclusif des Centres Urbains au Togo (PAICUT), au titre des exercices 2024 et 2025.",
    descriptionEn:
      "Environmental and social performance audit of the Inclusive Sanitation Promotion Project for Urban Centres in Togo (PAICUT), covering the 2024 and 2025 financial years.",
    fullDescription:
      "KARAMON CONSEIL a réalisé l'audit de performance environnementale et sociale du Projet de Promotion de l'Assainissement Inclusif des Centres Urbains au Togo (PAICUT), financé par la Banque Africaine de Développement, au titre des exercices 2024 et 2025.\n\nCe projet vise à améliorer l'accès à des services d'assainissement adéquats dans les centres urbains togolais, avec une attention particulière portée à l'inclusion des populations vulnérables.\n\nL'audit a permis d'évaluer la performance environnementale et sociale de la mise en œuvre du projet sur les deux exercices considérés, et de formuler des recommandations pour le renforcement des mesures de sauvegarde.",
    fullDescriptionEn:
      "KARAMON CONSEIL carried out the environmental and social performance audit of the Inclusive Sanitation Promotion Project for Urban Centres in Togo (PAICUT), financed by the African Development Bank, covering the 2024 and 2025 financial years.\n\nThis project aims to improve access to adequate sanitation services in Togolese urban centres, with particular attention paid to the inclusion of vulnerable populations.\n\nThe audit assessed the environmental and social performance of the project's implementation over the two financial years considered, and formulated recommendations to strengthen safeguard measures.",
    client: "Banque Africaine de Développement",
    clientEn: "African Development Bank",
    location: "Togo",
    locationEn: "Togo",
  ...
  },
  {
    ...
    slug: "projet-13",
    description:
      "Réalisation de l'audit d'achèvement de la mise en œuvre du Plan d'Action de Réinstallation des personnes affectées par le projet d'aménagement de la route Boké-Québo, Phase 1, lot 2.",
    descriptionEn:
      "Completion audit of the implementation of the Resettlement Action Plan for people affected by the Boké-Québo road development project, Phase 1, lot 2.",
    fullDescription:
      "KARAMON CONSEIL a réalisé l'audit d'achèvement de la mise en œuvre du Plan d'Action de Réinstallation (PAR) des personnes affectées par le projet d'aménagement de la route Boké-Québo, Phase 1, lot 2, en République de Guinée, financé par la Banque Africaine de Développement.\n\nCet audit d'achèvement a permis de vérifier que l'ensemble des engagements de compensation et de restauration des moyens de subsistance envers les populations affectées par l'emprise routière ont été effectivement mis en œuvre.\n\nLa mission a également évalué la satisfaction des personnes affectées et la clôture effective des mécanismes de gestion des plaintes mis en place dans le cadre du projet.",
    fullDescriptionEn:
      "KARAMON CONSEIL carried out the completion audit of the implementation of the Resettlement Action Plan (RAP) for people affected by the Boké-Québo road development project, Phase 1, lot 2, in the Republic of Guinea, financed by the African Development Bank.\n\nThis completion audit verified that all compensation and livelihood restoration commitments towards people affected by the road right-of-way had been effectively implemented.\n\nThe assignment also assessed the satisfaction of affected people and the effective closure of the grievance management mechanisms set up under the project.",
    client: "Banque Africaine de Développement",
    clientEn: "African Development Bank",
  ...
  },
  {
    ...
    slug: "projet-14",
    description:
      "Réalisation de quatre missions d'audit de conformité/performance environnementale et sociale, incluant la mise en œuvre des PAR du Programme d'Appui au Secteur de l'Eau et au Renforcement de la Résilience au Changement Climatique (PASEREC), Phase 1, au titre des exercices 2024 à 2027.",
    descriptionEn:
      "Four environmental and social compliance/performance audit assignments, including the implementation of RAPs under the Water Sector Support and Climate Change Resilience Strengthening Programme (PASEREC), Phase 1, covering the 2024 to 2027 financial years.",
    fullDescription:
      "KARAMON CONSEIL a été retenu pour la réalisation de quatre missions d'audit de conformité et de performance environnementale et sociale du Programme d'Appui au Secteur de l'Eau et au Renforcement de la Résilience au Changement Climatique (PASEREC), Phase 1, au Burundi, financé par la Banque Africaine de Développement.\n\nCes audits, couvrant les exercices 2024, 2025, 2026 et 2027, incluent l'évaluation de la mise en œuvre des Plans d'Action de Réinstallation (PAR) associés au programme.\n\nLa mission vise à s'assurer de la conformité continue du programme aux exigences de sauvegarde environnementale et sociale de la BAD, tout au long de sa mise en œuvre.",
    fullDescriptionEn:
      "KARAMON CONSEIL was selected to carry out four environmental and social compliance and performance audit assignments for the Water Sector Support and Climate Change Resilience Strengthening Programme (PASEREC), Phase 1, in Burundi, financed by the African Development Bank.\n\nThese audits, covering the 2024, 2025, 2026 and 2027 financial years, include the assessment of the implementation of the Resettlement Action Plans (RAP) associated with the programme.\n\nThe assignment aims to ensure the programme's continued compliance with AfDB environmental and social safeguard requirements throughout its implementation.",
    client: "Banque Africaine de Développement",
    clientEn: "African Development Bank",
    location: "Burundi",
    locationEn: "Burundi",
  ...
  },
  {
    ...
    slug: "projet-16",
    description:
      "Audit d'achèvement de la mise en œuvre des Plans d'Action de Réinstallation du Projet de Renforcement des Réseaux Électriques de Transport et de Distribution (PRETD) en Côte d'Ivoire.",
    descriptionEn:
      "Completion audit of the implementation of the Resettlement Action Plans for the Electricity Transport and Distribution Network Strengthening Project (PRETD) in Côte d'Ivoire.",
    fullDescription:
      "KARAMON CONSEIL a réalisé l'audit d'achèvement de la mise en œuvre des Plans d'Action de Réinstallation (PAR) du Projet de Renforcement des Réseaux Électriques de Transport et de Distribution (PRETD) en Côte d'Ivoire, financé par la Banque Africaine de Développement.\n\nCe projet vise à renforcer et moderniser les infrastructures de transport et de distribution d'électricité ivoiriennes, afin d'améliorer la fiabilité de l'approvisionnement électrique national.\n\nL'audit d'achèvement a permis de vérifier la mise en œuvre complète des engagements de compensation envers les personnes affectées par les emprises des réseaux électriques, et la clôture effective des mécanismes de gestion des doléances.",
    fullDescriptionEn:
      "KARAMON CONSEIL carried out the completion audit of the implementation of the Resettlement Action Plans (RAP) for the Electricity Transport and Distribution Network Strengthening Project (PRETD) in Côte d'Ivoire, financed by the African Development Bank.\n\nThis project aims to strengthen and modernise Ivorian electricity transport and distribution infrastructure, in order to improve the reliability of the national electricity supply.\n\nThe completion audit verified the full implementation of compensation commitments towards people affected by the electricity network rights-of-way, and the effective closure of the grievance management mechanisms.",
    client: "Banque Africaine de Développement",
    clientEn: "African Development Bank",
    location: "Côte d'Ivoire",
    locationEn: "Côte d'Ivoire",
...
/* ============================================================
 * MESSAGES DE CONTACT (stockage en mémoire, non persistant)
 * ============================================================
 * Sans base de données, les messages envoyés via le formulaire de contact
 * ne peuvent pas être conservés de façon permanente : ils sont simplement
 * journalisés côté serveur (console.log) au moment de l'envoi. Si vous avez
 * besoin de conserver ces messages durablement, il faudra brancher un envoi
 * d'email (SMTP) ou une base de données.
 */
...
const PROJECT_TRANSLATABLE_FIELDS = ['title', 'description', 'fullDescription', 'client', 'location']
const ACTUALITE_TRANSLATABLE_FIELDS = ['title', 'excerpt', 'content', 'category']

export function getAllProjects(locale: string = 'fr'): Project[] {
  return [...projects]
    .sort((a, b) => new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime())
    .map((p) => localize(p, locale, PROJECT_TRANSLATABLE_FIELDS))
}
...
export function getPublishedActualites(locale: string = 'fr'): Actualite[] {
  return actualites
    .filter((a) => a.published)
    .sort((a, b) => new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime())
    .map((a) => localize(a, locale, ACTUALITE_TRANSLATABLE_FIELDS))
}

export function getActualiteBySlug(slug: string, locale: string = 'fr'): Actualite | undefined {
